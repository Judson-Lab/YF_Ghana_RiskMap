...
* **coverage_by_district_year_opt2000.csv** - district-level vaccination coverage estimates generated from running the model code; these serve as covariates in risk mapping.
